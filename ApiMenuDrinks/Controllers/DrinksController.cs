...

{
    ...
    {
        private readonly IDrinkRepositorio drinkRepositorio;
        public DrinksController(IDrinkRepositorio drinks)
        {
            drinkRepositorio = drinks;
        }
        [HttpGet]
        ...
        public IActionResult Remover([FromRoute] int id)
        {
            ...
            if (drink == null)
            {
                return NotFound($"Drink com esse código não existe!");
            }
            drinkRepositorio.Delete(id);
            return Ok();
